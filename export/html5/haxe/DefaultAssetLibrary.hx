...
@:keep @:bind #if display private #end class __ASSET__assets_music_testmusic_antiguo1_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_music_testmusic_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_music_testmusic_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_enemy_explode_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_enemy_explode_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_enemy_hit_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_enemy_hit_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_enemy_nohit_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_enemy_nohit_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_enemy_shoot_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_enemy_shoot_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_enemy_spawn_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_enemy_spawn_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_absorb_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_absorb_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_blast_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_blast_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_death_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_death_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_double_pew_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_double_pew_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_hit_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_hit_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_pickup_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_pickup_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_switch_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_main_switch_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_pause_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_pause_wav extends null { }
...
@:file("D:/development/HaxeToolkit/haxe/lib/flixel/4,0,1/assets/sounds/beep.ogg") #if display private #end class __ASSET__flixel_sounds_beep_ogg extends lime.utils.Bytes {}
@:file("D:/development/HaxeToolkit/haxe/lib/flixel/4,0,1/assets/sounds/flixel.ogg") #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends lime.utils.Bytes {}
