...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("ith1ldin", "ld35", "com.example.myapp", "0.0.1");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (org.wildrabbit.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (org.wildrabbit.Main, Reflect.field (org.wildrabbit.Main, "main"), []);
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "ld35", null, { width: 960, height: 640 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (org.wildrabbit.Main, []);
			}
