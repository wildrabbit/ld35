...
{
HX_STACK_FRAME("haxe.xml._Fast.NodeAccess","new",0xde09fb0a,"haxe.xml._Fast.NodeAccess.new","D:\\development\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",29,0xb1a5b078)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(29)
