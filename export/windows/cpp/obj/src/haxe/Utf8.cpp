...
int Utf8_obj::charCodeAt( ::String s,int index){
	HX_STACK_FRAME("haxe.Utf8","charCodeAt",0xce7cbeab,"haxe.Utf8.charCodeAt","D:\\development\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Utf8.hx",61,0x324be2cc)
	HX_STACK_ARG(s,"s")
...
int Utf8_obj::length( ::String s){
	HX_STACK_FRAME("haxe.Utf8","length",0x88322e1b,"haxe.Utf8.length","D:\\development\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Utf8.hx",74,0x324be2cc)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(75)
	Array< int > array = ::__hxcpp_utf8_string_to_char_array(s);		HX_STACK_VAR(array,"array");
	HX_STACK_LINE(76)
