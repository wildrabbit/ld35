...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("ith1ldin","\xd1","\xd9","\xd9","\x60"),HX_HCSTRING("ld35","\x1a","\x19","\xaf","\x47"),HX_HCSTRING("com.example.myapp","\x84","\x30","\x57","\xc1"),HX_HCSTRING("0.0.1","\x35","\x3d","\xc8","\xc1"));
		HX_STACK_LINE(133)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","ApplicationMain.hx",52,0x0780ded5)
			{
				...
				HX_STACK_LINE(102)
				{
					...
					HX_STACK_LINE(102)
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::org::wildrabbit::Main >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(102)
					while((true)){
						HX_STACK_LINE(102)
				...
				if ((tmp29)){
					HX_STACK_LINE(115)
					Dynamic tmp30 = ::Reflect_obj::field(hx::ClassOf< ::org::wildrabbit::Main >(),HX_HCSTRING("main","\x39","\x38","\x56","\x48"));		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(115)
					::Reflect_obj::callMethod(hx::ClassOf< ::org::wildrabbit::Main >(),tmp30,cpp::ArrayBase_obj::__new());
				}
				else{
					HX_STACK_LINE(119)
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)960,(int)640,(int)60,(int)0,tmp22,HX_HCSTRING("ld35","\x1a","\x19","\xaf","\x47"),null(),null());
	}
return null();
}
