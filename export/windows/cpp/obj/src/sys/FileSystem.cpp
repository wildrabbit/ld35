...
bool FileSystem_obj::exists( ::String path){
	HX_STACK_FRAME("sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","D:\\development\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",33,0x6a98f149)
...
Dynamic FileSystem_obj::stat( ::String path){
	HX_STACK_FRAME("sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","D:\\development\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",42,0x6a98f149)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(43)
	::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(43)
	...
	if ((tmp2)){
		...
		struct _Function_2_1{
			inline static Dynamic Block( ::Date &tmp5,::Date &tmp4,::Date &tmp3){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","D:\\development\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",45,0x6a98f149)
				{
...
::String FileSystem_obj::fullPath( ::String relPath){
	HX_STACK_FRAME("sys.FileSystem","fullPath",0xc6463316,"sys.FileSystem.fullPath","D:\\development\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",52,0x6a98f149)
...
{
		HX_STACK_FRAME("sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","D:\\development\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",74,0x6a98f149)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(75)
		::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(75)
...
{
		HX_STACK_FRAME("sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","D:\\development\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",88,0x6a98f149)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(89)
		::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(89)
