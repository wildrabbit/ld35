...
Void FlxG_obj::init( ::flixel::FlxGame Game,int Width,int Height,Float Zoom){
{
		...
		HX_STACK_LINE(534)
		::flixel::input::touch::FlxTouchManager tmp18 = ::flixel::input::touch::FlxTouchManager_obj::__new();		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(534)
		::flixel::input::touch::FlxTouchManager tmp19 = tmp17->__Field(HX_HCSTRING("add_flixel_input_touch_FlxTouchManager","\xe6","\xdb","\x13","\x1c"), hx::paccDynamic )(tmp18);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(534)
		::flixel::FlxG_obj::touches = tmp19;
		HX_STACK_LINE(538)
		::flixel::_system::frontEnds::InputFrontEnd tmp20 = ::flixel::FlxG_obj::inputs;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(538)
		::flixel::input::gamepad::FlxGamepadManager tmp21 = ::flixel::input::gamepad::FlxGamepadManager_obj::__new();		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(538)
		::flixel::input::gamepad::FlxGamepadManager tmp22 = tmp20->__Field(HX_HCSTRING("add_flixel_input_gamepad_FlxGamepadManager","\x26","\xa8","\x4b","\x80"), hx::paccDynamic )(tmp21);		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(538)
		::flixel::FlxG_obj::gamepads = tmp22;
		HX_STACK_LINE(548)
		::flixel::util::FlxSave tmp23 = ::flixel::FlxG_obj::save;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(548)
		tmp23->bind(HX_HCSTRING("flixel","\x5c","\x42","\x70","\x3d"));
		HX_STACK_LINE(550)
		::flixel::_system::frontEnds::PluginFrontEnd tmp24 = ::flixel::_system::frontEnds::PluginFrontEnd_obj::__new();		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(550)
		::flixel::FlxG_obj::plugins = tmp24;
		HX_STACK_LINE(551)
		::flixel::_system::frontEnds::VCRFrontEnd tmp25 = ::flixel::_system::frontEnds::VCRFrontEnd_obj::__new();		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(551)
		::flixel::FlxG_obj::vcr = tmp25;
		HX_STACK_LINE(554)
		::flixel::_system::frontEnds::SoundFrontEnd tmp26 = ::flixel::_system::frontEnds::SoundFrontEnd_obj::__new();		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(554)
		::flixel::FlxG_obj::sound = tmp26;
	}
return null();
}
