...
Dynamic Multitouch_obj::set_inputMode( Dynamic value){
	...
	HX_STACK_LINE(51)
	bool tmp = (value == ((Dynamic)((int)0)));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(51)
	if ((tmp)){
		HX_STACK_LINE(53)
		Dynamic tmp1 = ::openfl::_legacy::ui::Multitouch_obj::get_inputMode();		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(53)
		return tmp1;
	}
	HX_STACK_LINE(57)
	...
	HX_STACK_LINE(57)
	bool tmp4 = (value == ((Dynamic)((int)2)));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(57)
