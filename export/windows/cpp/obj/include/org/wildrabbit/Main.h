...
#define INCLUDED_org_wildrabbit_Main
...
HX_DECLARE_CLASS2(org,wildrabbit,Main)
namespace org{
...
class HXCPP_CLASS_ATTRIBUTES  Main_obj : public ::openfl::_legacy::display::Sprite_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="org.wildrabbit.Main")
...
#endif /* INCLUDED_org_wildrabbit_Main */ 
